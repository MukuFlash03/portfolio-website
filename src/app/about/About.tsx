...
const About: React.FC<{
  ...
  aboutData,
    ...
    return (
      <div className="w-full min-h-[216px] flex bg-[#182546] px-5 rounded-[10px]">
        <div className="w-full flex-grow flex justify-center items-center">
          <div className="w-full h-full flex flex-col justify-center items-start space-y-6 px-5 py-5">
            {aboutData.map((data, index) => (
              <span key={index} className="w-full h-full text-[#E3E3E3] text-base leading-6 space-y-2 font-medium">
