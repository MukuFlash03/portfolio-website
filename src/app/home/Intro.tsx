  ...
  introData,
    ...
    return (
      <div className="w-full flex flex-col items-center space-y-2 md:space-y-10 px-1 md:px-5">
        <h1 className="w-full text-center text-xl md:text-[32px] leading-[30px] md:leading-[40px] font-bold text-[#E3E3E3]">
        ...
        <div className="w-full flex flex-col items-center justify-center space-y-0 px- md:px-5">
          {introData.description.map((description, index) => (
            <p key={index} className="w-full text-center text-base md:text-[18px] leading-[30px] font-medium text-[#E3E3E3]">{description}</p>
          ))}
        </div>
      </div>
    )
