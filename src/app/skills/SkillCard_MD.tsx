...
const SkillCard_MD: React.FC<{
  ...
  skillset: { category, skills },
    ...
    return (
      <div key={id} className="w-full min-h-[126px] flex flex-row bg-[#182546] mb-5 py-1 md:py-[13px] rounded-md md:rounded-lg">
        ...
        <div className="flex-grow flex flex-row gap-x-2 md:gap-x-[45px] gap-y-1 md:gap-y-4 px-1 md:px-5">
