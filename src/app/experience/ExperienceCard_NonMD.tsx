  ...
  experience
    ...
    return (
      <div key={id} className="w-full min-h-[216px] flex flex-col bg-[#182546] px-2 md:px-5 rounded-[8px] md:rounded-[10px]">
        <div className="flex-grow w-full h-full flex flex-col items-start space-y-1.5 py-1 md:py-5 pr-2 md:pr-8">
        ...
        <div className="w-full flex flex-col items-start py-4 p-1.25 mt-2.5 md:mt-3.5">
